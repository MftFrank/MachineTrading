...
load('/home/statarb/DataAnalysis/candle_data/scripts/ba_spot_future.mat');
...
for i = 1:53
    try
        ...
        pairB = string(fut_future{i, 2});
        csvPathA = strcat('/home/statarb/DataAnalysis/candle_data/', pairA, '_SPOT_1h.csv');
...
% 将表格写入CSV文件
csvPath = 'coint_SF.csv';  % 指定CSV文件的路径和名称
